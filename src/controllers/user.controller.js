...
const registerUser = asyncHandler(async (req, res) => {
    ...
    // const coverImageLocalPath = req.files?.coverImage?.[0]?.path; //gives error when cover image is not uploaded so we check classic way
    ...
    if (!createdUser) {
        throw new ApiError(500, "Something went wronge! User creation failed")
    }
